...
UPDATE dishes 
SET image_url='server/images/dishes/soup_of_the_day.png' 
WHERE name='Soup of the day';

UPDATE dishes 
SET image_url='server/images/dishes/dreamy_skewers.png' 
WHERE name='Dreamy skewers';

UPDATE dishes 
SET image_url='server/images/dishes/tamara_double_morning.png' 
WHERE name='Tamara Double Morning';

UPDATE dishes 
SET image_url='server/images/dishes/spicy_tomato_shakshuka.png' 
WHERE name='Spicy tomato shakshuka';

UPDATE dishes 
SET image_url='server/images/dishes/smoked_salmon_toast.png' 
WHERE name='Smoked salmon toast';

UPDATE dishes 
SET image_url='server/images/dishes/tamara_toast.png' 
WHERE name='Tamara Toast';

UPDATE dishes 
SET image_url='server/images/dishes/cheesy_toast.png' 
WHERE name='Cheesy toast';

UPDATE dishes 
SET image_url='server/images/dishes/creamy_salmon_fettuccine.png' 
WHERE name='Creamy salmon fettuccine';

UPDATE dishes 
SET image_url='server/images/dishes/penna_wild_mushroom_cream.png' 
WHERE name='Penna Wild Mushroom Cream';

UPDATE dishes 
SET image_url='server/images/dishes/lemon_pistachio_bar.png' 
WHERE name='Lemon pistachio bar';

UPDATE dishes 
SET image_url='server/images/dishes/new_york_cheesecake.png' 
WHERE name='New York cheesecake';

UPDATE dishes 
SET image_url='server/images/dishes/pizza_emilia.png' 
WHERE name='Pizza Emilia';

UPDATE dishes 
SET image_url='server/images/dishes/goat_pizza.png' 
WHERE name='Goat pizza';

UPDATE dishes 
SET image_url='server/images/dishes/sweet_potato_walnut_salad.png' 
WHERE name='Sweet potato and walnut salad';

UPDATE dishes 
SET image_url='server/images/dishes/greek_piraeus_salad.png' 
